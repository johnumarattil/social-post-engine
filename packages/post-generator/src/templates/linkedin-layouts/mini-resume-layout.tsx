...
export function render(props: LayoutProps, t: Theme): JSX.Element {
  ...
  const name = (layoutData?.name as string) ?? persona.name;
  const jobTitle = (layoutData?.jobTitle as string) ?? persona.title;
  ...
  return (
    ...
    >
      ...
      >
        <MiniResume name={name} title={jobTitle} variant="light" />
      </div>
